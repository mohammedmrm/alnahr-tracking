...
<body>
          ...
          <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item u-header__nav-last-item">
                <a id="searchSlideDownInvoker" class="btn btn-xs btn-icon btn-text-secondary u-search-slide-down-trigger" href="javascript:;" role="button" aria-haspopup="true" aria-expanded="false" aria-controls="searchSlideDown" data-unfold-type="css-animation" data-unfold-hide-on-scroll="false" data-unfold-target="#searchSlideDown" data-unfold-animation-in="active" data-unfold-animation-out="fadeOutUp" data-unfold-delay="0" data-unfold-duration="800" data-unfold-overlay='{
    ...
    <div class="container d-lg-flex align-items-lg-center space-top-2 space-top-md-5 space-lg-0 min-height-lg-100vh">
      ...
      <div id="SVGMainHero" class="col-lg-9 col-xl-7 svg-preloader d-none d-lg-block position-absolute top-0 right-0 pr-0" style="margin-top: 105.6px;">
        <figure class="ie-main-hero">
          <img class="js-svg-injector" src="assets/svg/illustrations/main-hero.svg" alt="Image Description" data-img-paths='[
  ...
  <div id="SVGfiles" class="svg-preloader bg-light position-relative z-index-2">
    ...
    <div class="d-none d-lg-block w-100 position-absolute bottom-0 right-0 z-index-n1 max-width-27">
      <figure class="ie-files">
        <img class="js-svg-injector" src="assets/svg/illustrations/files.svg" alt="Image Description" data-parent="#SVGfiles">
      </figure>
    </div>
    <!-- End SVG Icon -->
  </div>
  ...
  <div class="col-md-12 bg-dark">
    <footer class="container text-center space-2">
      ...
      <span class="text-white">Please contact us on this information for needed details</span>
      <span class="text-white">للاتصال والحصول على اي معلومات, يرجى استخدام معلومات الاتصال التاليه</span>
